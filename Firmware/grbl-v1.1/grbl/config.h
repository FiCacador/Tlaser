...
#define DEFAULTS_TLASER // Tlaser default settings
...
*/
...
#ifdef DEFAULTS_TLASER  // Tlaser default settings.
  ...
  #define DEFAULT_X_MAX_TRAVEL 315.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 205.0 // mm NOTE: Must be a positive value.
  ...
  #define DEFAULT_JUNCTION_DEVIATION 0.03 // mm
  ...
  #define DEFAULT_HOMING_DIR_MASK 3 // move negative dir XY
